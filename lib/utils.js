...
function isMythixOrWebComponent(element) {
  ...
  try {
    if (element[MYTHIX_TYPE] === MYTHIX_UI_COMPONENT_TYPE)
      return true;
  } catch (e) {
    // Ignore errors
  }
 ...
 */
export function createScanningProxy(startElement) {
 ...
 */
export function mythixEventWrapper(event) {
 ...
 */
export function bindDataEventAttribute(element, eventName) {
 ...
 */
export function bindAllDataEventAttributes(element) {
